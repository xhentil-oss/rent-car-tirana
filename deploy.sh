...
echo "  rm -f backend/public/.htaccess"
echo "  cp -r dist/. backend/public/   # ← pika '.' kopjon edhe .htaccess"
echo ""
echo "  # Verifikim:"
echo "  grep -oE 'index-[A-Za-z0-9_-]+\\.js' backend/public/index.html"
echo "  ls -la backend/public/.htaccess"
